...
let lat, lng, nearbyInformation, accuracy;
...
function showPosition(position) {
	...
	console.log(lat + ", " + lng);
	let url = "https://script.google.com/macros/s/AKfycbzSNkKTyh5mxoIrTUKt71OmORrWFijtnqHUf7PUo8k4NCaqYfm8AkKXTHdrRHxEc4kiPg/exec?q=markdown&des=MTR-Info&lat=" + lat + "&lng=" + lng + "&acc=" + accuracy;
